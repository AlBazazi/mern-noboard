    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-[#1a1a2e] border border-gray-700 rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-400 text-center mb-8">Create an account to save your notes</p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <p className="text-gray-500 text-sm text-center">
              Already have an account? <a href="/login" className="text-blue-400 hover:text-blue-300 font-medium">Login</a>
            </p>
          </div>
        </div>
      </div>
